...
<p>
    <b>Σημείωση:</b> Οποιαδήποτε λογικά πρόσφατη έκδοση της Python είναι αποδεκτή για αυτό το μάθημα.
    Εάν έχετε ήδη μια έκδοση της Python 3.x στον υπολογιστή σας, θα πρέπει να μπορείτε να την χρησιμοποιήσετε
    για αυτήν την τάξη.
</p>
<p>
    Κατεβάστε και εγκαταστήστε την Python 3.x από το:
</p>
<p>
    <a href="http://www.python.org/download/" target="_blank">http://www.python.org/download/</a>
</p>
<p>
    Κατά την εγκατάσταση της Python, βεβαιωθείτε ότι έχετε επιλέξει το "Add Python 3.5 to PATH", ώστε να μπορείτε να πληκτρολογήσετε 
    <b>python</b> στη γραμμή εντολών για να εκτελέσετε Python.
</p>
<b>Εγκατάσταση του Συντάκτη Κειμένου Προγραμματισμού</b>
<p>Εάν έχετε ήδη εγκατεστημένο κάποιον επεξεργαστή κειμένου προγραμματισμού, όπως τον 
...
<p>
    ...
    συνδεδεμένος λογαριασμός σας θα πρέπει να χρησιμοποιείται αντί του csev.
</p>
<pre>
...
<p>Η γραμμή γραμμής εντολών συνήθως περιλαμβάνει κάποια ένδειξη για το πού βρίσκεστε στη δομή φακέλου στον σκληρό σας δίσκο.</p>
<p>Αν θέλετε πραγματικά να καταλάβετε πού βρίσκεστε, χρησιμοποιήστε την εντολή cd χωρίς παραμέτρους</p>
<pre>
    C:\Users\csev> cd
    C:\Users\csev
</pre>
...
<p>
    ...
    αρχεία βρίσκονται στον τρέχοντα κατάλογο και την εντολή <b>cd ..</b> για να πάτε "<b style="color:black;background-color:#a0ffff">επάνω</b>" έναν κατάλογο
</p>
<p> 
    <b>Έξυπνο Κόλπο:</b> Στην εντολή cd, μπορείτε να πληκτρολογήσετε μερικώς ένα όνομα φακέλου, όπως το Desktop, και στη συνέχεια 
...
<p>Μερικές Καλές Συμβουλές στη Διεπαφή Γραμμής Εντολών των Windows</p>
<p>
...
<p> 
    ...
    <b>Υπόδειξη:</b> Μπορείτε να χρησιμοποιήσετε το πλήκτρο βέλους <b style = "color: black; background-color:#a0ffff">επάνω</b> 
