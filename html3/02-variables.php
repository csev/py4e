...
<p><strong>Exercise 1: Escribe las siguientes sentencias en el intérprete de Python para comprobar qué hacen:</strong></p>
...
<p><strong>Exercise 2: Escribe un programa que use <code>input</code> para pedirle al usuario su nombre y luego darle la bienvenida.</strong></p>
<pre><code>Introduzca tu nombre: Chuck
Hola, Chuck</code></pre>
<p><strong>Exercise 3: Escribe un programa para pedirle al usuario el número de horas y la tarifa por hora para calcular el salario bruto.</strong></p>
...
<p><strong>Exercise 4: Asume que ejecutamos las siguientes sentencias de asignación:</strong></p>
<pre><code>ancho = 17
alto = 12.0</code></pre>
...
<p><strong>Exercise 5: Escribe un programa que le pida al usuario una temperatura en grados Celsius, la convierta a grados Fahrenheit e imprima por pantalla la temperatura convertida.</strong></p>
<div class="footnotes">
<hr />
<ol>
