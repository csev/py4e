...
<p>  </p>
<p>A <em>value</em> is one of the basic things a program works with, like a letter or a number. The values we have seen so far are <code>1</code>, <code>2</code>, and &quot;Hello, World!&quot;</p>
<p>These values belong to different <em>types</em>: <code>2</code> is an integer, and &quot;Hello, World!&quot; is a <em>string</em>, so called because it contains a &quot;string&quot; of letters. You (and the interpreter) can identify strings because they are enclosed in quotation marks.</p>
<p></p>
...
&lt;class &#39;str&#39;&gt;</code></pre>
<p>They're strings.</p>
<p>When you type a large integer, you might be tempted to use commas between groups of three digits, as in <code>1,000,000</code>. This is not a legal integer in Python, but it is legal:</p>
<pre class="python trinket" height="120"><code>&gt;&gt;&gt; print(1,000,000)
1 0 0</code></pre>
<p>Well, that's not what we expected at all! Python interprets <code>1,000,000</code> as a comma-separated sequence of integers, which it prints with spaces between.</p>
<p>  </p>
...
<p>This example makes three assignments. The first assigns a string to a new variable named <code>message</code>; the second assigns the integer <code>17</code> to <code>n</code>; the third assigns the (approximate) value of <span class="math inline"><em>π</em></span> to <code>pi</code>.</p>
...
<p><code>76trombones</code> is illegal because it begins with a number. <code>more@</code> is illegal because it contains an illegal character, <code>@</code>. But what's wrong with <code>class</code>?</p>
...
<pre class="python"><code>20+32   hour-1   hour*60+minute   minute/60   5**2   (5+9)*(15-7)</code></pre>
...
&gt;&gt;&gt; minute/60
0</code></pre>
<p>To obtain the same answer in Python 3.0 use floored ( // integer) division.</p>
<pre class="python trinket" height="160"><code>&gt;&gt;&gt; minute = 59
&gt;&gt;&gt; minute//60
0</code></pre>
...
<p>Exercise 1: Type the following statements in the Python interpreter to see what they do:</p>
...
<li><p><em>M</em>ultiplication and <em>D</em>ivision have the same precedence, which is higher than <em>A</em>ddition and <em>S</em>ubtraction, which also have the same precedence. So <code>2*3-1</code> is 5, not 4, and <code>6+4/2</code> is 8.0, not 5.</p></li>
<li><p>Operators with the same precedence are evaluated from left to right. So the expression <code>5-3-1</code> is 1, not 3, because the <code>5-3</code> happens first and then <code>1</code> is subtracted from <code>2</code>.</p></li>
</ul>
...
&gt;&gt;&gt; print(first + second)
100150</code></pre>
<p>The output of this program is <code>100150</code>.</p>
<h2 id="asking-the-user-for-input">Asking the user for input</h2>
<p></p>
<p>Sometimes we would like to take the value for a variable from the user via their keyboard. Python provides a built-in function called <code>input</code> that gets input from the keyboard<a href="#fn1" class="footnoteRef" id="fnref1"><sup>1</sup></a>. When this function is called, the program stops and waits for the user to type something. When the user presses <code>Return</code> or <code>Enter</code>, the program resumes and <code>input</code> returns what the user typed as a string.</p>
<p></p>
<pre class="python"><code>&gt;&gt;&gt; input = input()
Some silly stuff
&gt;&gt;&gt; print(input)
...
<p>We call these wisely chosen variable names &quot;mnemonic variable names&quot;. The word <em>mnemonic</em><a href="#fn2" class="footnoteRef" id="fnref2"><sup>2</sup></a> means &quot;memory aid&quot;. We choose mnemonic variable names to help us remember why we created the variable in the first place.</p>
...
<p><code>word *in* words*:*\</code> <code>*print* word</code></p>
...
<p>Exercise 2: Write a program that uses <code>input</code> to prompt a user for their name and then welcomes them.</p>
<pre><code>Enter your name: Chuck
Hello Chuck</code></pre>
<p>Exercise 3: Write a program to prompt the user for hours and rate per hour to compute gross pay.</p>
...
<p>Exercise 4: Assume that we execute the following assignment statements:</p>
<pre><code>width = 17
...
<p>Exercise 5: Write a program which prompts the user for a Celsius temperature, convert the temperature to Fahrenheit, and print out the converted temperature.</p>
<div class="footnotes">
<hr />
<ol>
<li id="fn1"><p>In Python 2.0, this function was named <code>raw_input</code>.<a href="#fnref1">↩</a></p></li>
<li id="fn2"><p>See <a href="http://en.wikipedia.org/wiki/Mnemonic" class="uri">http://en.wikipedia.org/wiki/Mnemonic</a> for an extended description of the word &quot;mnemonic&quot;.<a href="#fnref2">↩</a></p></li>
</ol>
</div>
</body>
</html>
