...
<h2 class="author">Exploring Data Using Python 3</h2>
...
<div class="figure">
<img src="../images/pda2.svg" alt="Programmers Talking to You" />
<p class="caption">Programmers Talking to You</p>
</div>
...
<div class="figure">
<img src="../images/arch2.svg" alt="Where Are You?" />
...
<p>When we train a dog, we use special words like &quot;sit&quot;, &quot;stay&quot;, and &quot;fetch&quot;. When you talk to a dog and don't use any of the reserved words, they just look at you with a quizzical look on their face until you say a reserved word. For example, if you say, &quot;I wish more people would walk to improve their overall health&quot;, what most dogs likely hear is, &quot;blah blah blah <em>walk</em> blah blah blah blah.&quot; That is because &quot;walk&quot; is a reserved word in dog language. Many might suggest that the language between humans and cats has no reserved words<a href="#fn1" class="footnoteRef" id="fnref1"><sup>1</sup></a>.</p>
...
<p>And we have even written our first syntactically correct Python sentence. Our sentence starts with the function <em>print</em> followed by a string of text of our choosing enclosed in single quotes.</p>
...
<pre class="bash"><code>    csev$ cat hello.py
    print(&#39;Hello world!&#39;)
    csev$ python hello.py
    Hello world!
    csev$</code></pre>
<p>The &quot;csev$&quot; is the operating system prompt, and the &quot;cat hello.py&quot; is showing us that the file &quot;hello.py&quot; has a one-line Python program to print a string.</p>
...
<p>Exercise 1: What is the function of the secondary memory in a computer?</p>
...
<p>Exercise 2: What is a program?</p>
<p>Exercise 3: What is the difference between a compiler and an interpreter?</p>
<p>Exercise 4: Which of the following contains &quot;machine code&quot;?</p>
<p>a) The Python interpreter<br />
b) The keyboard<br />
c) Python source file<br />
d) A word processing document</p>
<p>Exercise 5: What is wrong with the following code:</p>
<pre class="python"><code>    &gt;&gt;&gt; primt &#39;Hello world!&#39;
      File &quot;&lt;stdin&gt;&quot;, line 1
        primt &#39;Hello world!&#39;
                           ^
    SyntaxError: invalid syntax
    &gt;&gt;&gt;</code></pre>
<p>Exercise 6: Where in the computer is a variable such as &quot;x&quot; stored after the following Python line finishes?</p>
...
d) Input Devices<br />
e) Output Devices</p>
<p>Exercise 7: What will the following program print out:</p>
...
<p>Exercise 8: Explain each of the following using an example of a human capability: (1) Central processing unit, (2) Main Memory, (3) Secondary Memory, (4) Input Device, and (5) Output Device. For example, &quot;What is the human equivalent to a Central Processing Unit&quot;?</p>
<p>Exercise 9: How do you fix a &quot;Syntax Error&quot;?</p>
<div class="footnotes">
<hr />
<ol>
