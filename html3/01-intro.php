...
<h1 id="why-should-you-learn-to-write-programs">Why should you learn to
write programs?</h1>
<p>Writing programs (or programming) is a very creative and rewarding
...
<em>everyone</em> needs to know how to program, and that once you know
how to program you will figure out what you want to do with your
newfound skills.</p>
<p>We are surrounded in our daily lives with computers ranging from
...
the question, “What would you like me to do next?”</p>
<figure>
...
<p>Programmers add an operating system and a set of applications to the
...
<p>Our computers are fast and have vast amounts of memory and could be
...
mind-numbing.</p>
<p>For example, look at the first three paragraphs of this chapter and
...
this chapter.</p>
<p>This very fact that computers are good at things that humans are not
...
inventiveness to this partnership.</p>
<h2 id="creativity-and-motivation">Creativity and motivation</h2>
<p>While this book is not intended for professional programmers,
...
your choice.</p>
<p>If we think of programs as the creative output of groups of
...
<p>For now, our primary motivation is not to make money or please end
...
you, your thoughts may turn toward developing programs for others.</p>
<h2 id="computer-hardware-architecture">Computer hardware
architecture</h2>
<p> </p>
<p>Before we start learning the language we speak to give instructions
...
phone and look deep inside, you would find the following parts:</p>
<figure>
...
<ul>
<li><p>The <em>Central Processing Unit</em> (or CPU) is the part of the
...
how to talk fast to keep up with the CPU.</p></li>
<li><p>The <em>Main Memory</em> is used to store information that the
...
turned off.</p></li>
<li><p>The <em>Secondary Memory</em> is also used to store information,
...
players).</p></li>
<li><p>The <em>Input and Output Devices</em> are simply our screen,
keyboard, mouse, microphone, speaker, touchpad, etc. They are all of the
ways we interact with the computer.</p></li>
<li><p>These days, most computers also have a <em>Network
Connection</em> to retrieve information over a network. We can think of
...
unreliable form of <em>Secondary Memory</em>.</p></li>
</ul>
<p>While most of the detail of how these components work is best left to
computer builders, it helps to have some terminology so we can talk
about these different parts as we write our programs.</p>
<p>As a programmer, your job is to use and orchestrate each of these
...
<p>You need to be the person who answers the CPU’s “What next?”
...
<em>program</em> and the act of writing these instructions down and
getting the instructions to be correct <em>programming</em>.</p>
<h2 id="understanding-programming">Understanding programming</h2>
<p>In the rest of this book, we will try to turn you into a person who
is skilled in the art of programming. In the end you will be a
<em>programmer</em> - perhaps not a professional programmer, but at
least you will have the skills to look at a data/information analysis
problem and develop a program to solve the problem.</p>
<p></p>
<p>In a sense, you need two skills to be a programmer:</p>
<ul>
<li><p>First, you need to know the programming language (Python) - you
...
well-formed “sentences” in this new language.</p></li>
<li><p>Second, you need to “tell a story”. In writing a story, you
...
to solve is the “idea”.</p></li>
</ul>
<p>Once you learn one programming language such as Python, you will find
...
<p>You will learn the “vocabulary” and “sentences” of Python pretty
...
becomes a very pleasant and creative process.</p>
<p>We start with the vocabulary and structure of Python programs. Be
...
blah blah <em>walk</em> blah blah blah blah.” That is because “walk” is
a reserved word in dog language. Many might suggest that the language
between humans and cats has no reserved words<a href="#fn1"
...
fail.</p>
<p>We will learn these reserved words and how they are used in good
...
sentence. Our sentence starts with the function <em>print</em> followed
...
language skills.</p>
<p>Before you can converse with Python, you must first install the
...
consult <a href="http://www.py4e.com">www.py4e.com</a> where I have
...
terminal or command window and you will type <em>python</em> and the
...
information.
&gt;&gt;&gt;</code></pre>
<p>The <code>&gt;&gt;&gt;</code> prompt is the Python interpreter’s way
...
<p>Luckily you brought a copy of this book on your travels, and you
thumb to this very page and try again:</p>
...
communicate with it, Python is <em>not</em> intelligent. You are really
just having a conversation with yourself, but using proper syntax.</p>
...
<p>Before we leave our first conversation with the Python interpreter,
...
<p>The proper way to say “good-bye” to Python is to enter
<em>quit()</em> at the interactive chevron <code>&gt;&gt;&gt;</code>
...
<h2 id="terminology-interpreter-and-compiler">Terminology: Interpreter
and compiler</h2>
<p>Python is a <em>high-level</em> language intended to be relatively
...
<p>The CPU understands a language we call <em>machine language</em>.
Machine language is very simple and frankly very tiresome to write
because it is represented all in zeros and ones:</p>
...
language is not <em>portable</em> across different types of hardware.
...
<p>These programming language translators fall into two general
categories: (1) interpreters and (2) compilers.</p>
...
later. We use the term <em>variable</em> to refer to the labels we use
to refer to this stored data.</p>
...
label <em>x</em> so we can retrieve the value later. We verify that
Python has actually remembered the value using <em>print</em>. Then we
ask Python to retrieve <em>x</em> and multiply it by seven and put the
newly computed value in <em>y</em>. Then we ask Python to print out the
value currently in <em>y</em>.</p>
<p>Even though we are typing these commands into Python one line at a
...
<p>It is the nature of an <em>interpreter</em> to be able to have an
interactive conversation as shown above. A <em>compiler</em> needs to be
...
<p>If you were to open an executable file in a text editor, it would
look completely crazy and be unreadable:</p>
...
....</code></pre>
<p>It is not easy to read or write machine language, so it is nice that
we have <em>interpreters</em> and <em>compilers</em> that allow us to
write in high-level languages like Python or C.</p>
<p>Now at this point in our discussion of compilers and interpreters,
...
type “python”, what exactly is happening?</p>
<p>The Python interpreter is written in a high-level language called
“C”. You can look at the actual source code for the Python interpreter
by going to <a href="http://www.python.org">www.python.org</a> and
...
<p>That is more than you really need to know to be a Python programmer,
but sometimes it pays to answer those little nagging questions right at
the beginning.</p>
<h2 id="writing-a-program">Writing a program</h2>
<p>Typing commands into the Python interpreter is a great way to
...
Python instructions into a file, which is called a <em>script</em>. By
convention, Python scripts have names that end with
<code>.py</code>.</p>
<p></p>
<p>To execute the script, you have to tell the Python interpreter the
name of the file. In a command window, you would type
<code>python hello.py</code> as follows:</p>
<pre class="bash"><code>$ cat hello.py
print(&#39;Hello world!&#39;)
$ python hello.py
Hello world!</code></pre>
<p>The “$” is the operating system prompt, and the “cat hello.py” is
showing us that the file “hello.py” has a one-line Python program to
print a string.</p>
<p>We call the Python interpreter and tell it to read its source code
from the file “hello.py” instead of prompting us for lines of Python
code interactively.</p>
<p>You will notice that there was no need to have <em>quit()</em> at the
...
<p>The definition of a <em>program</em> at its most basic is a sequence
of Python statements that have been crafted to do something. Even our
simple <em>hello.py</em> script is a program. It is a one-line program
and is not particularly useful, but in the strictest definition, it is a
Python program.</p>
<p>It might be easiest to understand what a program is by thinking about
a problem that a program might be built to solve, and then looking at a
program that would solve that problem.</p>
<p>Lets say you are doing Social Computing research on Facebook posts
...
<p>For example, look at the following text about a clown and a car. Look
...
<p>Then imagine that you are doing this task looking at millions of
...
called <em>words.py</em> and run it or you download the source code from
<a href="http://www.py4e.com/code3/"
class="uri">http://www.py4e.com/code3/</a> and run it.</p>
<p></p>
<p>This is a good example of how Python and the Python language are
...
talking <em>to Python</em>, instead we are communicating with each other
<em>through</em> Python.</p>
<h2 id="the-building-blocks-of-programs">The building blocks of
programs</h2>
...
<p>The word counting program above directly uses all of these patterns
except for one.</p>
<h2 id="what-could-possibly-go-wrong">What could possibly go wrong?</h2>
<p>As we saw in our earliest conversations with Python, we must
...
program.</p>
<p>Beginning programmers often take the fact that Python leaves no room
...
program than where Python <em>noticed</em> it was confused. So the line
...
do what you <em>intended</em> for it to do. A simple example would be if
...
<p>Again in all three types of errors, Python is merely trying its
hardest to do exactly what you have asked.</p>
<h2 id="debugging">Debugging</h2>
<p></p>
<p>When Python spits out an error or even when it gives you a result
...
<p>Beginning programmers sometimes get stuck on one of these activities
...
your head.</p>
<p></p>
<p>Running experiments can help, especially if you run small, simple
...
<p>Taking a break helps with the thinking. So does talking. If you
explain the problem to someone else (or even to yourself), you will
sometimes find the answer before you finish asking the question.</p>
<p>But even the best debugging techniques will fail if there are too
many errors, or if the code you are trying to fix is too big and
complicated. Sometimes the best option is to retreat, simplifying the
program until you get to something that works and that you
understand.</p>
<p>Beginning programmers are often reluctant to retreat because they
...
<p>As you progress through the rest of the book, don’t be afraid if the
...
be able to write an interesting complete short story on your own.</p>
<p>We want you to learn Python much more rapidly, so we teach it all at
...
you are currently staring at seems a bit impenetrable.</p>
<p>Usually when you are learning your first programming language, there
...
see that you are indeed building a beautiful sculpture.</p>
<p>If something seems particularly hard, there is usually no value in
...
<hr />
<ol>
<li id="fn1"><p><a href="http://xkcd.com/231/"
