...
<p>Η συγγραφή προγραμμάτων (ή προγραμματισμός) είναι μια πολύ δημιουργική και ανταποδοτική δραστηριότητα. Μπορεί να γράψετε προγράμματα για πολλούς λόγους, που κειμένονται από το να αποκομίσετε τα προς το ζην έως το να επιλύσετε ένα δύσκολο πρόβλημα ανάλυσης δεδομένων ή να διασκεδάσετε ή να βοηθήσετε κάποιον άλλο να λύσει ένα πρόβλημα. Αυτό το βιβλίο θεωρεί ότι <em>όλοι</em> πρέπει να γνωρίζουν πώς να προγραμματίζουν και ότι μόλις μάθουν πώς να προγραμματίζουν θα βρουν και τι θέλουν να κάνουν με τη νέα τους δεξιότητα.</p>
<p>Είμαστε περιτριγυρισμένοι στην καθημερινότητά μας από υπολογιστές, που κυμαίνονται από φορητούς υπολογιστές έως κινητά τηλέφωνα. Μπορούμε να φανταστούμε αυτούς τους υπολογιστές ως τους «προσωπικούς μας βοηθούς», που μπορούν να φροντίσουν πολλά πράγματα για λογαριασμό μας. Το υλικό στους σημερινούς υπολογιστές είναι ουσιαστικά κατασκευασμένο για να μας θέτει συνεχώς την ερώτηση “Τι θα θέλατε να κάνω στη συνέχεια;”</p>
<figure>
<img src="c:/MAMP/htdocs/py4e/images/pda.svg" alt="Προσωπικός Ψηφιακός Βοηθός" style="height: 1.0in;"/><figcaption>Προσωπικός Ψηφιακός Βοηθός</figcaption>
</figure>
<p>Οι προγραμματιστές προσθέτουν ένα λειτουργικό σύστημα και ένα σύνολο εφαρμογών στο υλικό και καταλήγουμε σε έναν Προσωπικό Ψηφιακό Βοηθό (PDA), που είναι ιδιαίτερα χρήσιμος και ικανός στο να μας βοηθήσει να κάνουμε πολλά διαφορετικά πράγματα.</p>
...
<figure>
<img src="c:/MAMP/htdocs/py4e/images/pda2.svg" alt="Οι προγραμματιστές σας μιλάνε" style="height: 1.0in;"/><figcaption>Οι προγραμματιστές σας μιλάνε</figcaption>
</figure>
...
<p> </p>
<p>Πριν ξεκινήσουμε να μαθαίνουμε τη γλώσσα, την οποία πρέπει να μιλάμε, ώστε να δίνουμε οδηγίες στους υπολογιστές, για την ανάπτυξη λογισμικού, πρέπει να μάθουμε λίγα πράγματα για τον τρόπο κατασκευής των υπολογιστών. Αν αποσυναρμολογούσατε τον υπολογιστή ή το κινητό σας τηλέφωνο και κοιτούσατε βαθιά μέσα του, θα βρίσκατε τα ακόλουθα μέρη:</p>
<figure>
<img src="c:/MAMP/htdocs/py4e/images/arch.svg" alt="Αρχιτεκτονική Υλικού" style="height: 1.75in;"/><figcaption>Αρχιτεκτονική Υλικού</figcaption>
</figure>
...
<li><p>Η <em>Κύρια Μνήμη</em> χρησιμοποιείται για την γρήγορη αποθήκευση πληροφοριών, που χρειάζεται η CPU. Η κύρια μνήμη είναι σχεδόν τόσο γρήγορη όσο η CPU. Αλλά οι πληροφορίες που είναι αποθηκευμένες στην κύρια μνήμη εξαφανίζονται όταν ο υπολογιστής απενεργοποιηθεί.</p></li>
<li><p>Η <em>Δευτερεύουσα Μνήμη</em> χρησιμοποιείται, επίσης, για την αποθήκευση πληροφοριών, αλλά είναι πολύ πιο αργή από την κύρια μνήμη. Το πλεονέκτημα της δευτερεύουσας μνήμης είναι ότι μπορεί να κρατήσει αποθηκευμένες τις πληροφορίες ακόμη και όταν σταματά η τροφοδοσία ρεύματος στον υπολογιστή. Παραδείγματα δευτερεύουσας μνήμης είναι οι μονάδες δίσκου ή η μνήμη flash (συνήθως συναντώνται σε USB sticks και φορητές συσκευές αναπαραγωγής μουσικής).</p></li>
...
<li><p>Στις μέρες μας, οι περισσότεροι υπολογιστές διαθέτουν επίσης <em>Σύνδεση Δικτύου</em>, για ανάκτηση πληροφοριών μέσω δικτύου. Μπορούμε να σκεφτόμαστε το δίκτυο ως ως μία πολύ αργή θέση, για την αποθήκευση και την ανάκτηση δεδομένων, που μπορεί να μην είναι πάντα “up”, δηλαδή διαθέσιμο. Κατά κάποιον τρόπο, το δίκτυο είναι μια πιο αργή και μερικές φορές αναξιόπιστη μορφή <em>Δευτερεύουσας Μνήμης</em>.</p></li>
</ul>
<p>Ενώ οι περισσότερες λεπτομέρειες, για το πώς λειτουργούν αυτά τα εξαρτήματα είναι καλύτερα να αφεθούν στους κατασκευαστές υπολογιστών, βοηθά να γνωρίζουμε την ορολογία, ώστε να μπορούμε να μιλάμε για αυτά τα βασικά κομμάτια του υπολογιστή καθώς θα προχωράμε στη συγγραφή των προγράμματά μας.</p>
...
<p></p>
<p>Στην ουσία, χρειάζονται δύο δεξιότητες για να είστε προγραμματιστής:</p>
<ul>
...
<p> </p>
<p>Σε αντίθεση με τις ανθρώπινες γλώσσες, το λεξιλόγιο της Python είναι πραγματικά πολύ μικρό. Αυτό το «λεξιλόγιο» το αποκαλούμε «δεσμευμένες λέξεις». Αυτές είναι λέξεις που έχουν πολύ ιδιαίτερη σημασία για την Python. Όταν η Python βλέπει αυτές τις λέξεις σε ένα πρόγραμμα Python, έχουν μία και μοναδική σημασία. Αργότερα, καθώς γράφετε κώδικα, θα φτιάχνετε τις δικές σας λέξεις, που θα έχουν νόημα για εσάς και ονομάζονται <em>μεταβλητές</em>. Θα έχετε ένα μεγάλο εύρος επιλογών για την ονοματολογία των μεταβλητών σας, αλλά δεν μπορείτε να χρησιμοποιήσετε καμία από τις δεσμευμένες λέξεις της Python, ως όνομα μεταβλητής.</p>
<p>Όταν εκπαιδεύουμε έναν σκύλο, χρησιμοποιούμε ειδικές λέξεις όπως “κάθισε”, “μείνε” και “φέρε”. Όταν μιλάτε σε ένα σκυλί και δεν χρησιμοποιείτε καμία από αυτές τις δεσμευμένες λέξεις, απλώς σας κοιτά με ένα ερωτηματικό βλέμμα στο πρόσωπό του μέχρι να πείτε μια δεσμευμένη λέξη. Για παράδειγμα, αν πείτε: “Μακάρι να περπατούσαν περισσότερο οι άνθρωποι, για να βελτιώσουν την υγεία τους”, αυτό που πιθανότατα ακούνε τα περισσότερα σκυλιά είναι “μπλα μπλα μπλα <em>περπάτα</em> μπλα μπλα μπλα μπλα.” Αυτό συμβαίνει επειδή το “περπάτα” είναι μια δεσμευμένη λέξη στη γλώσσα του σκύλου. Πολλοί μπορεί να αντιτείνουν ότι η γλώσσα μεταξύ ανθρώπων και γατών δεν έχει δεσμευμένες λέξεις<a href="#fn1" class="footnote-ref" id="fnref1"><sup>1</sup></a>.</p>
<p>Κάποιες από τις δεσμευμένες λέξεις στη γλώσσα, που οι άνθρωποι χρησιμοποιούν με την Python, είναι και οι ακόλουθες:</p>
...
<p>Θα μάθουμε αυτές τις δεσμευμένες λέξεις και πώς χρησιμοποιούνται έγκυρα, αλλά προς το παρόν θα επικεντρωθούμε στο ισοδύναμο του «μιλάω», της Python (σε γλώσσα ανθρώπου-σε-σκύλο). Το ωραίο, όταν λέμε στην Python να μιλήσει, είναι ότι μπορούμε ακόμη να της πούμε τι να πει, δίνοντάς της ένα μήνυμα σε εισαγωγικά:</p>
<pre class="python"><code>print(&#39;Γειά σου κόσμε!&#39;)</code></pre>
<p>Και, μόλις, γράψαμε την πρώτη μας, συντακτικά σωστή, πρόταση σε Python. Η πρόταση μας ξεκινά με τη συνάρτηση <em>print</em>, ακολουθούμενη από ένα κείμενο της επιλογής μας, που περικλείεται σε απλά εισαγωγικά. Οι προτάσεις (συμβολοσειρές) στις εντολές εκτύπωσης περικλείονται σε εισαγωγικά. Τα απλά εισαγωγικά και τα διπλά εισαγωγικά είναι ισοδύναμα. Οι περισσότεροι χρησιμοποιούν απλά εισαγωγικά, εκτός από την περίπτωση όπου ένα μόνο εισαγωγικό (το οποίο είναι μπορεί να δηλώνει και “απόστροφο”) πρέπει να εμφανιστεί στη συμβολοσειρά.</p>
<h2 id="συνομιλία-με-την-python">Συνομιλία με την Python</h2>
<p>Τώρα που κατέχουμε μια λέξη και μια απλή πρόταση, στην Python, πρέπει να μάθουμε και πώς να ξεκινήσουμε μια συνομιλία με την Python, προκειμένου να δοκιμάσουμε τις νέες γλωσσικές μας δεξιότητες.</p>
<p>Για να καταφέρετε να συνομιλήσετε με την Python, πρέπει πρώτα να εγκαταστήσετε το λογισμικό της Python στον υπολογιστή σας καθώς και να μάθετε πώς να εκκινείτε την Python στον υπολογιστή σας. Αυτό απαιτεί πάρα πολλές λεπτομερές για να συμπεριληφθεί σε αυτό το κεφάλαιο, οπότε προτείνω να συμβουλευτείτε το <a href="http://www.gr.py4e.com">www.gr.py4e.com</a> όπου σας παρέχω λεπτομερείς οδηγίες και βίντεο, για τη ρύθμιση και την εκκίνηση της Python σε συστήματα Macintosh και Windows. Έτσι, κάποια στιγμή, σε ένα τερματικό ή στο παράθυρο εντολών θα πληκτρολογήσετε <em>python</em> και ο διερμηνευτής της Python θα αρχίσει να εκτελείται σε διαδραστική λειτουργία, οπότε θα δείτε κάτι σαν το παρακάτω:</p>
<p></p>
...
information.
&gt;&gt;&gt;</code></pre>
<p>Η προτροπή <code>&gt;&gt;&gt;</code> είναι ο τρόπος του διερμηνευτή της Python να σας ρωτήσει: “Τι θέλετε να κάνω στη συνέχεια;” Η Python είναι έτοιμη να συζητήσει μαζί σας. Το μόνο που πρέπει να γνωρίζετε είναι πώς να της μιλήσετε, σε γλώσσα Python.</p>
<p>Ας πούμε για παράδειγμα, ότι δεν γνωρίζατε ούτε τις πιο απλές λέξεις ή προτάσεις της γλώσσας Python. Μπορεί να θέλατε να χρησιμοποιήσετε την κλασσική πρόταση, που χρησιμοποιούν οι αστροναύτες όταν προσγειώνονται σε έναν μακρινό πλανήτη και προσπαθούν να μιλήσουν με τους κατοίκους του πλανήτη:</p>
...
<p>Ευτυχώς έχετε ένα αντίγραφο αυτού του βιβλίου, μαζί σας, στο ταξίδι σας και ανοίγοντάς το βρίσκεστε σε αυτήν ακριβώς τη σελίδα, οπότε προσπαθείτε ξανά:</p>
...
<p>Κατά μία έννοια, όταν χρησιμοποιείτε ένα πρόγραμμα γραμμένο από κάποιον άλλο, η συζήτηση γίνεται μεταξύ εσάς και εκείνου του άλλου προγραμματιστή, με την Python να ενεργεί ως ενδιάμεσος. Η Python είναι ένας τρόπος, για τους δημιουργούς προγραμμάτων, να εκφράσουν πώς υποτίθεται ότι θα προχωρήσει η συνομιλία. Και σε λίγα κεφάλαια παρακάτω, θα είστε ένας από αυτούς τους προγραμματιστές, που χρησιμοποιούν την Python για να μιλήσουν με τους χρήστες του προγράμματός τους.</p>
<p>Πριν αφήσουμε την πρώτη μας συνομιλία με τον διερμηνευτή της Python, μάλλον θα πρέπει να μάθετε τον “καθώς πρέπει” τρόπο για να πείτε “αντίο” όταν αλληλεπιδράτε με τους κατοίκους του Πλανήτη Python:</p>
...
SyntaxError: invalid syntax
&gt;&gt;&gt; quit()</code></pre>
<p>Θα παρατηρήσετε ότι το σφάλμα είναι διαφορετικό στις δύο πρώτες εσφαλμένες προσπάθειες. Το δεύτερο σφάλμα είναι διαφορετικό γιατί το <em>if</em> είναι μια δεσμευμένη λέξη και η Python είδε την δεσμευμένη λέξη και σκέφτηκε ότι προσπαθούσαμε να πούμε κάτι, αλλά αντιλήφθηκε λάθος στη σύνταξη της πρότασης.</p>
<p>Ο σωστός τρόπος για να πείτε “αντίο” στην Python είναι να πληκτρολογήσετε <em>quit()</em> στη διαδραστική προτροπή <code>&gt;&gt;&gt;</code>. Πιθανότατα θα σας έπαιρνε αρκετή ώρα για να το μαντέψετε, οπότε το να έχετε ένα βιβλίο κοντά σας πιθανότατα θα σας φανεί χρήσιμο.</p>
<h2 id="ορολογία-διερμηνευτής-και-μεταγλωττιστής">Ορολογία: διερμηνευτής και μεταγλωττιστής</h2>
...
42
&gt;&gt;&gt;</code></pre>
<p>Σε αυτό το παράδειγμα, ζητάμε από την Python να θυμάται την τιμή έξι και να χρησιμοποιήσει το όνομα <em>x</em>, ώστε να μπορούμε να ανακτήσουμε την τιμή αργότερα. Επαληθεύουμε ότι η Python έχει κρατήσει την τιμή, χρησιμοποιώντας το <em>print</em>. Στη συνέχεια, ζητάμε από την Python να ανακτήσει το <em>x</em> και να το πολλαπλασιάσει επί επτά και να θέσει την νέα τιμή που υπολόγισε στο <em>y</em>. Κατόπιν, ζητάμε από την Python να εκτυπώσει την τρέχουσα τιμή του <em>y</em>.</p>
<p>Παρόλο που πληκτρολογούμε αυτές τις εντολές Python, μία γραμμή τη φορά, η Python τις αντιμετωπίζει ως μια διατεταγμένη σειρά δηλώσεων με μεταγενέστερες δηλώσεις που μπορούν να ανακτήσουν δεδομένα που δημιουργήθηκαν σε προγενέστερες δηλώσεις. Γράφουμε την πρώτη μας απλή παράγραφο με τέσσερις προτάσεις, με λογική και ουσιαστική σειρά.</p>
<p>Είναι στη φύση ενός <em>διερμηνευτή</em> να μπορεί να έχει μια διαδραστική συνομιλία όπως φαίνεται παραπάνω. Σε έναν <em>μεταγλωττιστής</em> πρέπει να παραδοθεί ολόκληρο το πρόγραμμα, σε ένα αρχείο και στη συνέχεια εκτελεί μια διαδικασία για τη μετάφραση του πηγαίου κώδικα υψηλού επιπέδου σε γλώσσα μηχανής. Κατόπιν, ο μεταγλωττιστής αποθηκεύει την γλώσσα μηχανής, που προκύπτει σε ένα αρχείο, για μετέπειτα εκτέλεση.</p>
<p>Εάν διαθέτετε σύστημα Windows, συχνά αυτά τα εκτελέσιμα προγράμματα γλώσσας μηχανής έχουν ένα επίθημα “.exe” ή “.dll”, που σημαίνει “εκτελέσιμο” ή “dynamic link library / βιβλιοθήκη δυναμικών συνδέσμων” αντίστοιχα. Σε Linux και Macintosh, δεν υπάρχει επίθημα που να χαρακτηρίζει μοναδικά ένα αρχείο ως εκτελέσιμο.</p>
<p>Εάν ανοίγατε ένα εκτελέσιμο αρχείο σε έναν επεξεργαστή κειμένου, θα σας φαινόταν εντελώς τρελό και δεν θα μπορούσατε να το διαβάσετε:</p>
<pre class="text"><code>^?ELF^A^A^A^@^@^@^@^@^@^@^@^@^B^@^C^@^A^@^@^@\xa0\x82
^D^H4^@^@^@\x90^]^@^@^@^@^@^@4^@ ^@^G^@(^@$^@!^@^F^@
...
<p>Η πληκτρολόγηση εντολών στον διερμηνευτή της Python είναι ένας πολύ καλός τρόπος για να πειραματιστείτε με τις δυνατότητες της Python, αλλά δεν συνιστάται για την επίλυση πιο πολύπλοκων προβλημάτων.</p>
...
<p> </p>
<p>Για να εκτελέσετε το σενάριο, πρέπει να πείτε στον διερμηνευτή της Python το όνομα του αρχείου. Στο τερματικό / γραμμή εντολών, πληκτρολογείτε <code>python hello.py</code> ως εξής:</p>
<pre class="bash"><code>$ cat hello.py
print(&#39;Γειά σου κόσμε!&#39;)
$ python hello.py
Γειά σου κόσμε!</code></pre>
<p>Το “$” είναι η προτροπή του λειτουργικού συστήματος και το “cat hello.py” μας δείχνει το περιεχόμενο του αρχείου “hello.py”, που είναι ένα πρόγραμμα Python μιας γραμμής, για την εκτύπωση μιας συμβολοσειράς.</p>
<p>Καλούμε, στη συνέχεια, τον διερμηνευτή της Python και του λέμε να διαβάσει τον πηγαίο κώδικα από το αρχείο “hello.py” αντί να μας ζητήσει τις γραμμές του κώδικα Python διαδραστικά.</p>
...
<pre class="text"><code>the clown ran after the car and the car ran into the tent
...
<dl>
<dt>είσοδος</dt>
<dd>Λήψη δεδομένων από τον “έξω κόσμο”. Αυτή μπορεί να είναι η ανάγνωση δεδομένων από ένα αρχείο ή ακόμη και κάποιου είδους αισθητήρα όπως μικρόφωνο ή GPS. Στα αρχικά μας προγράμματα, η εισαγωγή θα προέρχεται από τον χρήστη που πληκτρολογεί δεδομένα στο πληκτρολόγιο.
</dd>
<dt>έξοδος</dt>
...
<dd>Έλεγχος ορισμένων συνθηκών και, στη συνέχεια, εκτέλεση ή παράληψη μιας ακολουθίας εντολών.
</dd>
...
<dd>Γραφή μιας σειράς εντολών μία φορά, απόδοση ονόματος σε αυτές και, στη συνέχεια, επαναχρησιμοποίησή τους, όπως χρειάζεται κάθε φορά, σε όλο το πρόγραμμά σας.
</dd>
</dl>
<p>Ακούγεται, σχεδόν, πάρα πολύ απλό για να είναι αληθινό, και φυσικά δεν είναι ποτέ τόσο απλό. Είναι σαν να λέμε ότι το περπάτημα είναι απλά «να βάζεις το ένα πόδι μπροστά από το άλλο». Η «τέχνη» της συγγραφής ενός προγράμματος συνθέτει και υφαίνει αυτά τα βασικά στοιχεία μαζί πολλές φορές, για να παράγει κάτι που είναι χρήσιμο για τους τελικούς χρήστες του.</p>
...
SyntaxError: invalid syntax
&gt;&gt;&gt;</code></pre>
<p>Δεν έχετε να κερδίσετε κάτι από τη διαμάχη με την Python. Είναι απλώς ένα εργαλείο. Δεν έχει συναισθήματα και είναι χαρούμενη και έτοιμη να σας εξυπηρετήσει όποτε το χρειαστείτε. Τα μηνύματα λάθους της ακούγονται σκληρά, αλλά είναι απλώς το κάλεσμα της Python σε βοήθεια. Έχει εξετάσει τι πληκτρολογήσατε και απλά δεν μπορεί να καταλάβει τι έχετε εισαγάγει.</p>
...
<dt>εκτέλεση</dt>
<dd>Πειραματιστείτε κάνοντας αλλαγές και εκτελώντας διαφορετικές εκδόσεις. Συχνά, εάν εμφανίζετε το σωστό πράγμα στο σωστό σημείο του προγράμματος, το πρόβλημα γίνεται εμφανές, αλλά μερικές φορές πρέπει να αφιερώσετε λίγο χρόνο για να φτιάξετε κρηπιδώματα.
</dd>
<dt>μηρυκασμός</dt>
...
<p> </p>
<p>Πρέπει να αφιερώσετε χρόνο στο να σκεφτείτε. Το Debugging είναι σαν μια πειραματική επιστήμη. Θα πρέπει να έχετε τουλάχιστον μία υπόθεση για το ποιο είναι το πρόβλημα. Εάν υπάρχουν δύο ή περισσότερες υποθέσεις, προσπαθήστε να σκεφτείτε μια δοκιμή που θα εξαλείψει κάποιες από αυτές.</p>
<p>Το διάλειμμα βοηθά στη σκέψη. Το ίδιο και η συζήτηση. Εάν εξηγήσετε το πρόβλημα σε κάποιον άλλο (ή ακόμα και στον εαυτό σας), μερικές φορές θα βρείτε την απάντηση πριν τελειώσετε την εξήγηση.</p>
...
<p>Συνήθως όταν μαθαίνετε την πρώτη σας γλώσσα προγραμματισμού, υπάρχουν μερικές υπέροχες “Αχά!” στιγμές, που μπορείτε, κάνοντας ένα βήμα πίσω, να κοιτάξετε από ψηλά το πελέκημα της πέτρας με σφυρί και σμίλη και να δείτε ότι πράγματι δημιουργείτε ένα όμορφο γλυπτό.</p>
...
<dt><strong>γλώσσα υψηλού επιπέδου</strong></dt>
...
<dt><strong>γλώσσα χαμηλού επιπέδου</strong></dt>
...
<dt><strong>δευτερεύουσα μνήμη</strong></dt>
...
<dt><strong>διαδραστική λειτουργία - interactive mode</strong></dt>
<dd>Ένας τρόπος χρήσης του διερμηνευτή της Python, πληκτρολογώντας εντολές και εκφράσεις στη γραμμή προτροπής.
</dd>
<dt><strong>διερμηνεία</strong></dt>
<dd>Η διαδικασία εκτέλεσης ένας προγράμματος σε γλώσσα υψηλού επιπέδου, μεταφράζοντάς το μία προς μία γραμμή.
</dd>
<dt><strong>επίλυση προβλήματος</strong></dt>
<dd>Η διαδικασία διατύπωσης ενός προβλήματος, εύρεσης μιας λύσης και διατύπωσης της λύσης αυτής.
</dd>
<dt><strong>κεντρική μονάδα επεξεργασίας</strong></dt>
<dd>Η καρδιά κάθε υπολογιστή. Είναι αυτή που τρέχει το λογισμικό που γράφουμε. Ονομάζεται επίσης “CPU” ή “επεξεργαστής”.
</dd>
<dt><strong>κύρια μνήμη</strong></dt>
<dd>Αποθηκεύει προγράμματα και δεδομένα. Η κύρια μνήμη χάνει τις πληροφορίες της όταν σταματήσει η τροφοδοσία ρεύματος.
</dd>
<dt><strong>μεταγλώττιση - compile</strong></dt>
...
<dt><strong>μεταφερσιμότητα</strong></dt>
...
<dt><strong>πρόγραμμα</strong></dt>
<dd>Ένα σύνολο οδηγιών, που καθορίζει έναν υπολογισμό.
</dd>
<dt><strong>προτροπή - prompt</strong></dt>
<dd>Όταν ένα πρόγραμμα εμφανίζει ένα μήνυμα και περιμένει από ο χρήστης να πληκτρολογήσει κάποια είσοδο στο πρόγραμμα.
</dd>
<dt><strong>σημασιολογία</strong></dt>
<dd>Το νόημα ενός προγράμματος.
</dd>
<dt><strong>σημασιολογικό λάθος</strong></dt>
<dd>Ένα σφάλμα σε ένα πρόγραμμα που ως αποτέλεσμα έχει το να κάνει κάτι διαφορετικό από αυτό που ήθελε ο προγραμματιστής.
</dd>
<dt><strong>συνάρτηση print</strong></dt>
<dd>Μια οδηγία προς τον διερμηνευτή της Python, που προκαλεί την εμφάνιση τιμών στην οθόνη.
</dd>
</dl>
<h2 id="ασκήσεις">Ασκήσεις</h2>
<p><strong>Άσκηση 1: Ποια είναι η λειτουργία της δευτερεύουσας μνήμης σε έναν υπολογιστή;</strong></p>
<p>a)Εκτελεί όλο τον υπολογισμό και τη λογική του προγράμματος<br />
b) Ανακτά ιστοσελίδες μέσω Διαδικτύου<br />
c) Αποθηκεύει πληροφορίες μακροπρόθεσμα, ακόμη και πέρα από έναν κύκλο ισχύος<br />
d) Δέχεται είσοδο από τον χρήστη</p>
<p><strong>Άσκηση 2: Τι είναι ένα πρόγραμμα;</strong></p>
<p><strong>Άσκηση 3: Ποια είναι η διαφορά μεταξύ μεταγλωττιστή και διερμηνευτή;</strong></p>
<p><strong>Άσκηση 4: Ποιο από τα παρακάτω περιέχει “κώδικα μηχανής”;</strong></p>
<p>a) Ο διερμηνευτής της Python<br />
b) Το πληκτρολόγιο<br />
c) Το πηγαίο αρχείο Python<br />
