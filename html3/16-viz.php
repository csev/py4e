...
<p>We will be using data from a free email list archiving service that
...
<p>The first step is to spider the repository. The base URL is
...
formatted message.</p>
<p>Sometimes the repository is missing a message. Perhaps administrators
...
restart <em>gmane.py</em>. This will unstick the spidering process and
...
<pre><code>Loaded messages= 51330 senders= 1584
Top 10 Oranizations
