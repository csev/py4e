...
<p>Exercise 1: Run the program on your system and see what numbers you get. Run the program more than once and see what numbers you get.</p>
...
<p>The first example computes the logarithm base 10 of the signal-to-noise ratio. The math module also provides a function called <code>log</code> that computes logarithms base <code>e</code>.</p>
<p>     </p>
...
<p>The strings in the print statements are enclosed in quotes. Single quotes and double quotes do the same thing; most people use single quotes except in cases like this where a single quote (which is also an apostrophe) appears in the string.</p>
<p></p>
...
<p>Exercise 2: Move the last line of this program to the top, so the function call appears before the definitions. Run the program and see what error message you get.</p>
<p>Exercise 3: Move the function call back to the bottom and move the definition of <code>print_lyrics</code> after the definition of <code>repeat_lyrics</code>. What happens when you run this program?</p>
...
<p>Exercise 4: What is the purpose of the &quot;def&quot; keyword in Python?</p>
...
<p>Exercise 5: What will the following Python program print out?</p>
...
d) ABC Zap ABC<br />
e) Zap Zap Zap</p>
<p>Exercise 6: Rewrite your pay computation with time-and-a-half for overtime and create a function called <code>computepay</code> which takes two parameters (<code>hours</code> and <code>rate</code>).</p>
<pre><code>Enter Hours: 45
Enter Rate: 10
Pay: 475.0</code></pre>
<p>Exercise 7: Rewrite the grade program from the previous chapter using a function called <code>computegrade</code> that takes a score as its parameter and returns a grade as a string.</p>
...
&gt; 0.6     D
&lt;= 0.6    F</code></pre>
<pre><code>Program Execution:</code></pre>
