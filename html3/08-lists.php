...
&gt;&gt;&gt; print(numbers)
[17, 5]</code></pre>
<p>The one-eth element of <code>numbers</code>, which used to be 123, is now 5.</p>
<p> </p>
...
&gt;&gt;&gt; print(t)
[&#39;s&#39;, &#39;p&#39;, &#39;a&#39;, &#39;m&#39;]</code></pre>
<p>Because <code>list</code> is the name of a built-in function, you should avoid using it as a variable name. I also avoid the letter <code>l</code> because it looks too much like the number <code>1</code>. So that's why I use <code>t</code>.</p>
...
<p><code>From stephen.marquard@uct.ac.za</code><em><code>Sat</code></em><code>Jan  5 09:14:16 2008</code></p>
...
<p></p>
<div class="figure">
<img src="../images/list1.svg" alt="Variables and Objects" />
<p class="caption">Variables and Objects</p>
</div>
...
[&#39;b&#39;, &#39;c&#39;]</code></pre>
<p>Exercise 1:</p>
<p>Write a function called <code>chop</code> that takes a list and modifies it, removing the first and last elements, and returns <code>None</code>.</p>
<p>Then write a function called <code>middle</code> that takes a list and returns a new list that contains all but the first and last elements.</p>
...
<p>It is tempting to write list code like this: ~<sub>~</sub> {.python} t = t.sort() # WRONG! ~<sub>~</sub></p>
<p> </p>
<p>Because <code>sort</code> returns <code>None</code>, the next operation you perform with <code>t</code> is likely to fail.</p>
<p>Before using list methods and operators, you should read the documentation carefully and then test them in interactive mode. The methods and operators that lists share with other sequences (like strings) are documented at <a href="https://docs.python.org/3.5/library/stdtypes.html#common-sequence-operations" class="uri">https://docs.python.org/3.5/library/stdtypes.html#common-sequence-operations</a>. The methods and operators that only apply to mutable sequences are documented at <a href="https://docs.python.org/3.5/library/stdtypes.html#mutable-sequence-types" class="uri">https://docs.python.org/3.5/library/stdtypes.html#mutable-sequence-types</a>.</p></li>
...
<p><code>From stephen.marquard@uct.ac.za</code><strong><code>Sat</code></strong><code>Jan  5 09:14:16 2008</code></p>
...
<p>Exercise 2: Figure out which line of the above program is still not properly guarded. See if you can construct a text file which causes the program to fail and then modify the program so that the line is properly guarded and test it to make sure it handles your new text file.</p>
<p>Exercise 3: Rewrite the guardian code in the above example without two <code>if</code> statements. Instead, use a compound logical expression using the <code>and</code> logical operator with a single <code>if</code> statement.</p>
...
<p>Exercise 4: Download a copy of the file from <a href="http://www.py4e.com/code3/romeo.txt">www.py4e.com/code3/romeo.txt</a></p>
<p></p>
<p>Write a program to open the file <code>romeo.txt</code> and read it line by line. For each line, split the line into a list of words using the <code>split</code> function.</p>
<p>For each word, check to see if the word is already in a list. If the word is not in the list, add it to the list.</p>
<p>When the program completes, sort and print the resulting words in alphabetical order.</p>
...
<p><strong>Exercise 5:</strong> Write a program to read through the mail box data and when you find line that starts with &quot;From&quot;, you will split the line into words using the <code>split</code> function. We are interested in who sent the message, which is the second word on the From line.</p>
<p><code>From stephen.marquard@uct.ac.za Sat Jan 5 09:14:16 2008</code></p>
<p>You will parse the From line and print out the second word for each From line, then you will also count the number of From (not From:) lines and print out a count at the end.</p>
<p>This is a good sample output with a few lines removed:</p>
...
<p><strong>Exercise 6:</strong> Rewrite the program that prompts the user for a list of numbers and prints out the maximum and minimum of the numbers at the end when the user enters &quot;done&quot;. Write the program to store the numbers the user enters in a list and use the <code>max()</code> and <code>min()</code> functions to compute the maximum and minimum numbers after the loop completes.</p>
