...
<p><strong>Exercise 3: Rewrite the guardian code in the above example without two <code>if</code> statements. Instead, use a compound logical expression using the <code>and</code> logical operator with a single <code>if</code> statement.</strong></p>
