...
<p></p>
<pre class="python"><code># Αναζητάμε τις γραμμές που περιέχουν τη λέξη &#39;From&#39;
import re
...
<pre class="python"><code># Αναζητάμε τις γραμμές που περιέχουν ένα σύμβολο at μεταξύ χαρακτήρων
import re
hand = open(&#39;mbox-short.txt&#39;)
for line in hand:
    line = line.rstrip()
