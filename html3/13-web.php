...
<figure>
<img src="../images/soa.svg" alt="Αρχιτεκτονική Προσανατολισμένη στις Υπηρεσίες (Service-oriented architecture)" style="height:3.0in;"/><figcaption>Αρχιτεκτονική Προσανατολισμένη στις Υπηρεσίες (Service-oriented architecture)</figcaption>
</figure>
