...
# Código: https://es.py4e.com/code3/xml1.py</code></pre>
...
<pre><code>Nombre: Chuck
Atributo: si</code></pre>
...
<p> </p>
<p>A menudo el XML tiene múltiples nodos y tenemos que escribir un bucle para procesarlos todos. En el programa siguiente, usamos un bucle para recorrer todos los nodos ‘usuario’:</p>
<pre class="python"><code>import xml.etree.ElementTree as ET
...
# Código: https://es.py4e.com/code3/xml2.py</code></pre>
<p>El método ‘findall’ devuelve una lista de subárboles que representan las estructuras ‘usuario’ del árbol XML. A continuación podemos escribir un bucle ‘for’ que busque en cada uno de los nodos usuario, e imprima el texto de los elementos ‘nombre’ e ‘id’, además del atributo ‘x’ de cada nodo usuario.</p>
<pre><code>Contador de usuarios: 2
Nombre Chuck
Id 001
Atributo 2
Nombre Brent
Id 009
Atributo 7</code></pre>
<p>Es importante incluir todos los elementos base en la declaración de ‘findall’ exceptuando aquel que se encuentra en el nivel superior (p. ej., ‘usuarios/usuario’). De lo contrario, Python no encontrará ninguno de los nodos que buscamos.</p>
<pre class="python"><code>import xml.etree.ElementTree as ET
...
print(&#39;Cuenta de usuarios:&#39;, len(lst2))</code></pre>
<p>‘lst’ almacena todos los elementos ‘usuario’ anidados dentro de su base ‘usuarios’. ‘lst2’ busca los elementos ‘usuario’ que no se encuentren anidados dentro del elemento de nivel superior ‘cosa’ donde no hay ninguno.</p>
<pre><code>Cuenta de usuarios: 2
Cuenta de usuarios: 0</code></pre>
...
# Código: https://es.py4e.com/code3/json2.py</code></pre>
...
# Código: https://es.py4e.com/code3/geojson.py</code></pre>
...
<pre class="python"><code># Mantener este archivo separado
...
# Código: https://es.py4e.com/code3/hidden.py</code></pre>
...
<p>Pero una vez añadida la información de seguridad, la URL se parecerá más a esto:</p>
...
# Código: https://es.py4e.com/code3/twitter1.py</code></pre>
<p>Cuando el programa se ejecuta, produce la salida siguiente:</p>
<pre><code>Ingresa una cuenta de Twitter:drchuck
...
Ingresa una cuenta de Twitter:</code></pre>
...
# Código: https://es.py4e.com/code3/twitter2.py</code></pre>
