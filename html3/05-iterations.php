...
<body><?php if ( file_exists("../booktop.php") ) {
  require_once "../booktop.php";
  ob_start();
}?>
<!DOCTYPE html>
...
<p>You can almost read the <code>while</code> statement as if it were English. It means, “While <code>n</code> is greater than 0, display the value of <code>n</code> and then reduce the value of <code>n</code> by</p>
<ol type="1">
<li>When you get to 0, exit the <code>while</code> statement and display the word <code>Blastoff!</code>”</li>
</ol>
<p></p>
...
<pre class="{text}"><code>Before: None
Loop: 3 3
Loop: 41 41
Loop: 12 41
Loop: 9 41
...
<pre class="{text}"><code>Enter a number: 4
Enter a number: 5
