...
print(&#39;¡Terminado!&#39;)</code></pre>
<p>En términos de Python, la variable <code>amigos</code> es una lista<a href="#fn1" class="footnoteRef" id="fnref1"><sup>1</sup></a> de tres cadenas y el bucle <code>for</code> se mueve recorriendo la lista y ejecuta su cuerpo una vez para cada una de las tres cadenas en la lista, produciendo esta salida:</p>
...
<hr />
<ol>
<li id="fn1"><p>Examinaremos las listas con más detalle en un capítulo posterior.<a href="#fnref1">↩</a></p></li>
</ol>
</div>
</body>
</html>
