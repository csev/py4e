...
<p>Μια μορφή επανάληψης στην Python είναι η εντολή <code>while</code>. Εδώ έχουμε ένα απλό πρόγραμμα που μετρά αντίστροφα από το πέντε και μετά λέει “Blastoff!”.</p>
