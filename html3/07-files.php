...
<div class="figure">
<img src="../images/arch.svg" alt="Secondary Memory" />
<p class="caption">Secondary Memory</p>
</div>
...
<div class="figure">
<img src="../images/handle.svg" alt="A File Handle" />
...
<p></p>
<p>For most systems, there are applications to convert from one format to another. You can find them (and read more about this issue) at <a href="wikipedia.org/wiki/Newline" class="uri">wikipedia.org/wiki/Newline</a>. Or, of course, you could write one yourself.</p>
