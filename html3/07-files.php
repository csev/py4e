...
<p><strong>You can download the file from</strong> <a
href="http://www.py4e.com/code3/mbox-short.txt">www.py4e.com/code3/mbox-short.txt</a></p>
<p><strong>Exercise 2: Write a program to prompt for a file name, and
then read through the file and look for lines of the form:</strong></p>
<pre><code>X-DSPAM-Confidence: 0.8475</code></pre>
<p><strong>When you encounter a line that starts with
“X-DSPAM-Confidence:” pull apart the line to extract the floating-point
number on the line. Count these lines and then compute the total of the
spam confidence values from these lines. When you reach the end of the
file, print out the average spam confidence.</strong></p>
<pre><code>Enter the file name: mbox.txt
Average spam confidence: 0.894128046745

Enter the file name: mbox-short.txt
Average spam confidence: 0.750718518519</code></pre>
<p><strong>Test your file on the <em>mbox.txt</em> and
<em>mbox-short.txt</em> files.</strong></p>
<p><strong>Exercise 3: Sometimes when programmers get bored or want to
have a bit of fun, they add a harmless <em>Easter Egg</em> to their
program. Modify the program that prompts the user for the file name so
that it prints a funny message when the user types in the exact file
name “na na boo boo”. The program should behave normally for all other
files which exist and don’t exist. Here is a sample execution of the
program:</strong></p>
...
<p><strong>We are not encouraging you to put Easter Eggs in your
programs; this is just an exercise.</strong></p>
</body>
</html>
