...
\date{Dr.~Charles R.
Severance\\[0.5em]\small Filipino-English (Taglish) Translation by:\\Engramar Bollas (Code.Sydney | Data Engineering Pilipinas)}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Personal Digital Assistant},height=1.0in]{../../../images/pda.eps}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Programmers Talking to You},height=1.0in]{../../../images/pda2.eps}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Hardware Architecture},height=1.75in]{../../../images/arch.eps}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Where Are You?},height=1.75in]{../../../images/arch2.eps}}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/words.py}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={If Logic},height=1.5in]{../../../images/if.eps}}
\caption{If Logic}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={If-Then-Else Logic},height=1.5in]{../../../images/if-else.eps}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={If-Then-ElseIf Logic},height=2.0in]{../../../images/elif.eps}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Nested If Statements},height=2.0in]{../../../images/nested.eps}}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/fahren.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/fahren2.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/lyrics.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/addtwo.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/copytildone1.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/copytildone2.py}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={String Indexes},height=0.75in]{../../../images/string.eps}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Secondary Memory},height=2.5in]{../../../images/arch.eps}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={A File Handle},height=2.0in]{../../../images/handle.eps}}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/open.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/search1.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/search2.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/search3.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/search4.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/search6.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/search7.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/avenum.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/avelist.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/search5.py}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Variables and Objects},height=0.5in]{../../../images/list1.eps}}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/count1.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/count2.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/soft.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/count3.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/re01.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/re02.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/re03.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/re04.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/re05.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/re06.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/re07.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/re10.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/re11.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/re12.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/re13.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/socket1.py}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={A Socket Connection},height=2.0in]{../../../images/socket.eps}}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/urljpeg.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/urllib1.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/urlwords.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/curl1.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/curl2.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/urlregex.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/urllinks.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/urllink2.py}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={A Tree Representation of XML},height=2.0in]{../../../images/xml-tree.eps}}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/xml1.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/xml2.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/json2.py}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Service-oriented architecture},height=3.0in]{../../../images/soa.eps}}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/objects.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/elev.py}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={A Program},height=1.20in]{../../../images/program.eps}}
\caption{A Program}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={A Program as Network of Objects},height=1.50in]{../../../images/program-oo.eps}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Ignoring Detail When Using an Object},height=1.50in]{../../../images/program-oo-code.eps}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Ignoring Detail When Building an Object},height=1.50in]{../../../images/program-oo-bs4.eps}}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/party2.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/party3.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/party4.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/party5.py}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/party6.py}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Relational Databases},height=2.0in]{../../../images/relational.eps}}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/db1.py}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={A Database Cursor},height=2.0in]{../../../images/cursor.eps}}
...
\CommentTok{\# Code: https://www.py4e.com/https://www.py4e.com/https://www.py4e.com/code3/db2.py}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Rows in a Table},height=1.5in]{../../../images/tracks.eps}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={A Verbose One-to-Many Data Model},height=1.5in]{../../../images/one-to-many-verbose.eps}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={A Succinct One-to-Many Data Model},height=1.5in]{../../../images/one-to-many.eps}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Tracks, Albums, and Artists},height=1.5in]{../../../images/tracks-albums-artists.eps}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={A Many to Many Relationship},height=1.5in]{../../../images/many-to-many.eps}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={A Many to Many Connector Table},height=1.5in]{../../../images/many-to-many-verbose.eps}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={An OpenStreetMap},height=2.0in]{../../../images/openstreet-map.eps}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={A Page Ranking},height=3.5in]{../../../images/pagerank.eps}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={A Word Cloud from the Sakai Developer List},height=3.5in]{../../../images/wordcloud.eps}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Sakai Mail Activity by Organization},height=2.0in]{../../../images/mailorg.eps}}
