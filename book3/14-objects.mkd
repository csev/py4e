...
In this variation, we are accessing the code from within the *class* and explicitly
...
We are not passing any parameters to the *constructor* and when the constructor returns,
