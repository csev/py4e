...
<div style="padding: bottom 10px; line-height: 1.6; letter-spacing: 0.1em;">
    ...
    <p>
        Αν θέλετε να περιηγηθείτε στην υπό κατασκευή σελίδα θα πρέπει να πληκτρολογήσετε <b>gr</b> ή <b>py4e</b> στο πλαίσιο στην αρχή της σελίδας!
    </p>
    <p>
        Αν πάλι θέλετε, μπορείτε να απολαύσετε μαθήματα του Dr. Chuck (στα αγγλικά) στους παρακάτω συνδέσμου: 
        <br>
    ...
    <p style="font-size:70%;padding-top: 20px;letter-spacing: normal">
        Οποιαδήποτε πρόταση-διόρθωση είναι ευπρόσδεκτη και μπορείτε να την επικοινωνήσετε μαζί μου στο <a href="mailto:dinakiourtidou1@gmail.com? subject=py4e%20Feedback">Κωνσταντία Δ. Κιουρτίδου</a>.
    </p>
</div>
...
<p>
Καλώς ορίσατε στον δωρεάν ιστότοπό μου για την Python για όλους.<br>
Τώρα που έχετε συνδεθεί, έχετε πρόσβαση στις λειτουργίες τύπου-μαθήματος του συγκεκριμένου ιστότοπου.
<ul>
<li>
Καθώς προχωράτε στα <a href="lessons">Μαθήματα</a> της σειράς μαθημάτων θα βλέπετε επιπλέον
συνδέσμους για τους αυτόματους βαθμολογητές (autograders) της τάξης. Μπορείτε να δοκιμάσετε αυτούς τους autograders και να λάβετε βαθμολογία.</li>
<li>
Μπορείτε να παρακολουθήσετε την πρόοδό σας στο μάθημα χρησιμοποιώντας την επιλογή <a href="assignments">Εργασίες</a>
και όταν ολοκληρώσετε μια ομάδα εργασιών, μπορείτε να κερδίσετε ένα <a href="badges">Badge - Σήμα</a>.
Μπορείτε να κατεβάσετε αυτά τα badges και να τα φιλοξενήσετε στον ιστότοπό σας ή να παραπέμψετε στις διευθύνσεις URL του σήματος
σε αυτόν τον ιστότοπο.</li>
<li>
Εάν θέλετε να χρησιμοποιήσετε αυτό το υλικο με άδεια Creative Commons στις δικές σας τάξεις, μπορείτε να κάνετε
<a href="materials.php">λήψη ή σύνδεση</a> στα περιεχόμενα αυτού του ιστότοπου, να <a href="tsugi/cc/">εξάγετε το υλικό του μαθήματος</a>
ως ένα IMS Common Cartridge®, ή να κάνετε αίτηση για ένα <a href="tsugi/admin/key/index.php">key και secret</a> 
IMS Learning Tools Interoperability® (LTI®) για να ξεκινήσετε τους αυτόματους βαθμολογητές από το LMS σας.
</li>
</ul>
<?php } else { ?>
<p>
Αυτός ο ιστότοπος παρέχει ένα σύνολο από δωρεάν 
...
και εργασίες για να βοηθήσει τους μαθητές να μάθουν πως να προγραμματίζουν σε Python.<br>
...
θα συμμετάσχετε στην μεταφρασμένη στα ελληνικά εκδοχή ενός δωρεάν, παγκόσμιου και ανοιχτού διαδικτυακού μαθήματος. Θα έχετε ένα βιβλίο βαθμολογίας, εργασίες αυτόματης βαθμολόγησης,
φόρουμ συζήτησης και μπορείτε να κερδίσετε διακριτικά για τις προσπάθειές σας.</p>
<p>
...
<p>
Ο κώδικας για αυτόν τον ιστότοπο, συμπεριλαμβανομένων των αυτόματων βαθμολογητών, των διαφανειών και του περιεχομένου των μαθημάτων,
στην αρχική τους μορφή (στα Αγγλικά),
είναι διαθέσιμος στο <a href="https://github.com/csev/py4e" target="_blank">GitHub</a>.  Αυτό σημαίνει ότι μπορείτε να φτιάξετε το δικό σας
αντίγραφο του ιστότοπου του μαθήματος, να το δημοσιεύστε και να το αλλάξετε με όποιον τρόπο θέλετε.  Ακόμα πιο συναρπαστικό, θα
μπορούσατε να μεταφράσετε ολόκληρο τον ιστότοπο (μάθημα) στη γλώσσα σας και να τον δημοσιεύστε.  Έχω δώσει 
...
<?php } ?>
Αυτός ο ιστότοπος χρησιμοποιεί το framework <a href="http://www.tsugi.org" target="_blank">Tsugi</a> για να ενσωματώσει ένα σύστημα
διαχείρισης μάθησης και να παράσχει τους αυτόματους βαθμολογητές.
Εάν ενδιαφέρεστε να συνεργαστείτε για να δημιουργήσετε έναν τέτοιου είδους ιστότοπο για τον εαυτό σας, δείτε την
ιστοσελίδα <a href="http://www.tsugi.org" target="_blank">tsugi.org</a> και/ή επικοινωνήστε μαζί μου.
</p>
<p>
