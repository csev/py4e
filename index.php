...
?>
<body style="font-family: sans-serif,Courier,monospace; width: 80%; max-width:500px;margin-left: auto; margin-right: auto;">
<center>
<h1>PY4e - GR<br/> για Όλους</h1>
<form method="post">
<input type="text" name="secret">
<input type="submit" value="Unlock">
<p>
    Η παρούσα σελίδα αποτελεί μετάφραση του επιτυχυμένου μαθήματος <a href="https://www.py4e.com" target="_blank">Python</a>,
    του Charles R. Severance - aka <a href="http://www.dr-chuck.com/" target="_blank">Dr. Chuck</a>.
</p>
<p style="font-size: 18; color: red;">
    <img src="undercon.jpg" alt="developer typing by a \'under constraction\' sign" width="500" height="600">
    Προς το παρόν τελεί υπό κατασκευή
</p>
<p>
    Αν θέλετε να περιηγηθήτε στην υποκατασκευή σελίδα θα πρέπει να πληκτρολογήσετε έναν κωδικό!
    (βλέπε <a href="https://www.cc4e.com" target="_blank">CC4e</a>).
...
<p>
Ο κώδικας αυτού του ιστότοπου, συμπεριλαμβανομένων των αυτόματων βαθμολογητών, των διαφανειών και του περιεχομένου των μαθημάτων, είναι διαθέσιμος στο
