...
<ul>
   <li>
      <p>
         ...
         ένα LTI 1.x. key Θα σας δοθούν οδηγίες για το πώς να χρησιμοποιήσετε τα διαπιστευτήριά σας μόλις λάβετε το κλειδί σας.
      </p>
   </li>
   <li>
      <p>
         ...
         ένα LTI key και ένα secret για την παροχή των εργαλείων που βασίζονται σε LTI που παρέχονται σε αυτό το Cartridge.
      </p>
   </li>
   <li>
      <p>
         Εάν το LMS σας υποστηρίζει <a href="https://www.imsglobal.org/specs/lticiv1p0" target="_blank">
         Διαλειτουργικότητα Εργαλείων Εκμάθησης® Content-Item Message</a> μπορείτε να συνδεθείτε και να υποβάλετε αίτηση για LTI 1.x Key και 
         secret και να εγκαταστήσετε αυτόν τον ιστότοπο στο LMS σας ως App Store / Αποθήκη Αντικειμένων Μάθησης, που θα σας επιτρέψει να συντάξετε
         ...
         το πώς να ρυθμίσετε το "κατάστημα εφαρμογών" στο LMS σας όταν λάβετε το key και το secret σας.
      </p>
   </li>
   <li>
      <p>
         Εάν χρησιμοποιείτε <a href="https://classroom.google.com" target="_blank">Google Classroom</a>,
         μπορείτε να συνδέσετε αυτόματα τους πόρους από αυτόν τον ιστότοπο στο Classroom σας με μια
   ...
   <li>
      <p>
         ...
         ειδική προβολή των μαθημάτων σε χαμηλή μορφοποίηση </a> για να κάνουμε αυτήν την αντιγραφή με το χέρι όσο πιο εύκολη μπορεί να γίνει.
      </p>
   </li>
</ul>
<p>
   <a href="courses">Μαθήματα/ιστοσελίδες που συνεργάζονται με αυτό το υλικό</a>
</p>
<p>
   ...
   και για να παρέχει αυτό το υλικό, ώστε να μπορεί να ενσωματωθεί εύκολα σε ένα Σύστημα Διαχείρισης Εκμάθησης όπως <a href="http://www.sakaiproject.org/" target="_blank">
...
<h1>Αρχείο Ήχου</h1>
<p>
   Εδώ βρίσκονται, αρχειοθετημένες, οι <a href="https://archive.org/details/201509UMSI502Podcasts_201601" target="_blank"> ζωντανές ηχογραφήσεις διαλέξεων </a>
