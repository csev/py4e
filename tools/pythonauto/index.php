...
<?php } ?>
        <p>
            Ο στόχος σας σε αυτόν τον αυτόματο βαθμολογητή είναι να γράψετε ή να επικολλήσετε ένα 
            πρόγραμμα, που υλοποιεί τα ζητούμενα της εργασίας. Εκτελείτε το πρόγραμμα πατώντας 
            "Έλεγχος κώδικα". Η έξοδος του προγράμματός σας εμφανίζεται στην ενότητα "Η έξοδός σας"
            της οθόνης. 
            Εάν "Η έξοδός σας" δεν ταιριάζει με την "Επιθυμητή έξοδο", δεν θα λάβετε βαθμολογία.
        </p>
        <p>
            Ακόμα κι αν "Η Έξοδός σας" ταιριάζει ακριβώς με την "Επιθυμητή Έξοδο", το πρόγραμμα αυτόματης 
            βαθμολόγησης εξακολουθεί να κάνει κάποιους ελέγχους, στον πηγαίο κώδικά σας, και να εμφανίζει
            κατάλληλα μηνύματα για να βεβαιωθεί ότι ολοκληρώσατε την εργασία χρησιμοποιώντας τις αναμενόμενες
            από το κεφάλαιο τεχνικές. Αυτά τα μηνύματα μπορούν επίσης να βοηθήσουν τους μαθητές, που πασχίζουν
            να βρουν κάποιο στοιχείο για να εντοπίσουν τι μπορεί να λείπει.
        </p>
        <p>
            Αυτός ο Αυτόματος βαθμολογητής κρατά την υψηλότερη βαθμολογία σας, όχι την τελευταία σας βαθμολογία.
            Μπορεί να πάρετε βαθμολογία από τη μέγιστη (1,0) έως και την ελάχιστη (0,0) όταν εκτελείτε τον κώδικά
            σας - αλλά εάν ήδη επιτύχει βαθμολογία 1,0 και στη συνέχεια κάνετε μια αποτυχημένη εκτέλεση, η
            αθμολογία σας δεν θα αλλάξει.
        </p>
<?php } ?>
<?php
