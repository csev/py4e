...
<h2>Python για Όλους</h2>
        <p>
                Ο στόχος αυτού του βιβλίου είναι να παρέχει μια εισαγωγή στον προγραμματισμό με γνώμονα την Πληροφορική. Η κύρια διαφορά μεταξύ της προσέγγισης της επιστήμης των 
                υπολογιστών και της προσέγγισης της Πληροφορικής που ακολουθείται σε αυτό το βιβλίο είναι η μεγαλύτερη εστίαση στη χρήση της Python για την επίλυση προβλημάτων 
                ανάλυσης δεδομένων που είναι κοινά στον κόσμο της Πληροφορικής.
        </p>
        <p>
                Τα δείγματα κώδικα και αρχεία δεδομένων για το βιβλίο είναι εδώ: <a href="http://www.py4e.com/code3/" target="_blank">Δείγματα Κώδικα</a>.
        </p>
        <p>
